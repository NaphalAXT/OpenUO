...
namespace OpenUO.Ultima.Windows.Forms.Controls
{
	public sealed class UOInstallationComboBox : ComboBox
	{
		...
		public new string DisplayMember { get { return base.DisplayMember; } set { ; } }

		public new string ValueMember { get { return base.ValueMember; } set { ; } }

		public InstallLocation SelectedInstallation { get { return SelectedValue as InstallLocation; } }

		public event EventHandler SelectedInstallationChanged { add { SelectedIndexChanged += value; } remove { SelectedIndexChanged -= value; } }
	}
}