...
namespace OpenUO.Core.PresentationFramework.Input
{
	public abstract class CommandBase : ICommand, IRaiseCanExecuteChanged
	{
		...
		public event EventHandler CanExecuteChanged { add { WeakReferenceManager.AddWeakReferenceHandler(ref _canExecuteChangedHandlers, value, 2); } remove { WeakReferenceManager.RemoveWeakReferenceHandler(_canExecuteChangedHandlers, value); } }
