...
namespace OpenUO.Ultima.Network
{
	public class PacketReader
	{
		...
		public double ReadDouble()
		{
			...
			ulong num = (((ulong)_data[_index++] << 56) | ((ulong)_data[_index++] << 48) | ((ulong)_data[_index++] << 40) |
						 ((ulong)_data[_index++] << 32) | ((ulong)_data[_index++] << 24) | ((ulong)_data[_index++] << 16) |
						 ((ulong)_data[_index++] << 8) | (_data[_index++]));
			return num;
		}
		...
		public long ReadInt64()
		{
			...
			return (((long)_data[_index++] << 56) | ((long)_data[_index++] << 48) | ((long)_data[_index++] << 40) |
					((long)_data[_index++] << 32) | ((long)_data[_index++] << 24) | ((long)_data[_index++] << 16) |
					((long)_data[_index++] << 8) | (_data[_index++]));
		}
		...
		public ulong ReadUInt64()
		{
			...
			return (((ulong)_data[_index++] << 56) | ((ulong)_data[_index++] << 48) | ((ulong)_data[_index++] << 40) |
					((ulong)_data[_index++] << 32) | ((ulong)_data[_index++] << 24) | ((ulong)_data[_index++] << 16) |
					((ulong)_data[_index++] << 8) | (_data[_index++]));
		}
