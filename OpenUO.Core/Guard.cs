...
namespace OpenUO.Core
{
	public static class Guard
	{
		...
		public static void AssertInRange(
			string parameterName, decimal minimumValue, decimal maximumValue, decimal actualValue)
		{
			if (minimumValue > maximumValue)
			{
				string message = String.Format(ErrorInvalidRange, parameterName, minimumValue, maximumValue);
		...
		public static void AssertInRange(
			string parameterName, DateTime minimumValue, DateTime maximumValue, DateTime actualValue)
		{
			if (minimumValue > maximumValue)
			{
				string message = String.Format(ErrorInvalidRange, parameterName, minimumValue, maximumValue);
