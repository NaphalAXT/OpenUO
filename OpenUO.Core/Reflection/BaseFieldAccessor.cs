...
namespace OpenUO.Core.Reflection
{
	...
	{
		public static FieldFastSetInvokeHandler<TargetType, FieldType> SetFieldInvoker<TargetType, FieldType>(
			string FieldName)
		{
			return SetFieldInvoker<TargetType, FieldType>(typeof(TargetType).GetField(FieldName));
		}

		public static FieldFastGetInvokeHandler<TargetType, FieldType> GetFieldInvoker<TargetType, FieldType>(
			string FieldName)
		{
		...
		public static FieldFastSetInvokeHandler<TargetType, FieldType> SetFieldInvoker<TargetType, FieldType>(FieldInfo Field)
		{
			...
			if (Field != null)
			{
				...
				return
					(FieldFastSetInvokeHandler<TargetType, FieldType>)
					dm.CreateDelegate(typeof(FieldFastSetInvokeHandler<TargetType, FieldType>));
			}
		...
		public static FieldFastGetInvokeHandler<TargetType, FieldType> GetFieldInvoker<TargetType, FieldType>(FieldInfo Field)
		{
			...
			DynamicMethod dm = new DynamicMethod("Get" + Field.Name, typeof(FieldType), new[] {objectType}, objectType);
			ILGenerator il = dm.GetILGenerator();
